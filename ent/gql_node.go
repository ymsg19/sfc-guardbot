...
func (m *Member) Node(ctx context.Context) (node *Node, err error) {
	...
	var buf []byte
	if buf, err = json.Marshal(m.DiscordUID); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(m.IsVerified); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "bool",
	...
	if buf, err = json.Marshal(m.VerificationExpiry); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "time.Time",
	...
	if buf, err = json.Marshal(m.HashedVerificationToken); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "[]byte",
		Name:  "hashed_verification_token",
		Value: string(buf),
	}
	if buf, err = json.Marshal(m.VerificationTokenExpiry); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "time.Time",
